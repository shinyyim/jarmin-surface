...
### D-002 · Delegation is per scenario, not a global level
...
### D-003 · `Field.long` instead of a fourth primitive
...
### D-004 · Conversation lives inside the card
...
### D-005 · Web surface, phone and desktop both first-class
...
### D-006 · A standing instruction capsule (amends D-004)
**Call:** Conversation *about a piece of work* stays inside that work's capsule (D-004). Added: one
...
**Why:** D-004's cost — "no place for a conversation that isn't about a specific piece of work" —
...
### D-007 · Grouping is the assistant's narration, not a time axis
...
### D-008 · Slide to confirm, and one accent colour
**Call:** The positive action inside an opened card is a slide-to-confirm; a plain click also works on desktop. Amends D-005's "no swipe": what was refused there was *accidental* swipes, and this gesture requires intent. The single accent is terracotta `#d95d44` used only for the Today dot, urgency chip, icon badge and the "Needs you" count. Green is reserved for done.
